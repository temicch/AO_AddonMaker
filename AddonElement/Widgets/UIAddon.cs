...
namespace Application.BL.Widgets
{
    ...
    public class UIAddon : File, IUIElement
    {
        ...
        public Reference<BlankFileProvider> LocalizedNameFileRef { get; set; }

        [XmlElement("localizedDescFileRef")]
        public Reference<BlankFileProvider> LocalizedDescFileRef { get; set; }
        ...
        [XmlArrayItem("Item")]
        public List<Reference<BlankFileProvider>> ScriptFileRefs { get; set; }
        ...
        public Reference<BlankFileProvider> VisObjects { get; set; }

        [XmlElement("aliasVisObjects")]
        public Reference<BlankFileProvider> AliasVisObjects { get; set; }

        [XmlElement("texts")]
        public Reference<BlankFileProvider> Texts { get; set; }
        ...
        [XmlElement("textures")]
        public Reference<BlankFileProvider> Textures { get; set; }
        ...
        [XmlElement("sounds")]
        public Reference<BlankFileProvider> Sounds { get; set; }
        ...
        public Reference<BlankFileProvider> DecalObjects { get; set; }
        ...
        [XmlIgnore]
        public ImageSource Bitmap => Forms.Count > 0 ? (Forms[0].Form?.File as IUIElement)?.Bitmap : null;
